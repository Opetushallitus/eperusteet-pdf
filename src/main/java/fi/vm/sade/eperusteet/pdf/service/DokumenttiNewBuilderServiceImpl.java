...
//
//        // Tutkintonimikkeet
//        List<TutkintonimikeKoodiD> nimikeKoodit = tutkintonimikeKoodiRepository
...
//        Set<SuoritustapaDto> suoritustavat = docBase.getPeruste().getSuoritustavat();
...
//                addKoulutuksenOsa(docBase, koulutuksenOsaDto, po, lapsi);
...
//                TekstiKappaleDto tk = (TekstiKappale) po;
//                if (!tk.isLiite()) {
...
//    }
//
//    private void addTekstikappale(DokumenttiPeruste docBase, TekstiKappaleDto tk, PerusteenOsaDto po,
