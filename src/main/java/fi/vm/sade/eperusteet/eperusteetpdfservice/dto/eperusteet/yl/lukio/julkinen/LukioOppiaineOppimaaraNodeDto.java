package fi.vm.sade.eperusteet.eperusteetpdfservice.dto.eperusteet.yl.lukio.julkinen;
...
public class LukioOppiaineOppimaaraNodeDto implements Serializable, Lokalisoitava {
    ...
    public LukioOppiaineOppimaaraNodeDto(Long id, Long parentId,
        ...
        this.pakollinenKurssiKuvaus = LokalisoituTekstiDto.localizeLaterById(pakollinenKurssiKuvausId);
        this.syventavaKurssiKuvaus = LokalisoituTekstiDto.localizeLaterById(syventavaKurssiKuvausId);
        this.soveltavaKurssiKuvaus = LokalisoituTekstiDto.localizeLaterById(soveltavaKurssiKuvausId);
        this.tavoitteet = LokalisoitavaOsaDto.localizedLaterByIds(tavoitteetOtsikkoId, tavoitteetTekstiId);
        this.arviointi = LokalisoitavaOsaDto.localizedLaterByIds(arviointiOtsikkoId, arviointiTekstiId);
        this.tehtava = LokalisoitavaOsaDto.localizedLaterByIds(tehtavaOtsikkoId, tehtavaTekstiId);
    }
