...
public class PdfGenerationServiceImpl implements PdfGenerationService{
    ...
    public byte[] xhtml2pdf(Document document, GeneratorVersion version, DokumenttiMetaDto meta) throws IOException, TransformerException, SAXException {
        ...
        if (version == GeneratorVersion.KVLIITE) {
    ...
    private void convertFO2PDF(InputStream fo, OutputStream pdf, DokumenttiMetaDto meta) throws IOException, SAXException, TransformerException {
