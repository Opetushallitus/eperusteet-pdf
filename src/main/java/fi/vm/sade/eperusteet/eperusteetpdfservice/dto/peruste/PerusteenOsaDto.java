...
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.digi.OsaamiskokonaisuusDto;
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.digi.OsaamiskokonaisuusPaaAlueDto;
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.tutkinnonosa.TutkinnonOsaDto;
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.tuva.KoulutuksenOsaDto;
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.tuva.TuvaLaajaAlainenOsaaminenDto;
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.util.LokalisoituTekstiDto;
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.vst.KotoKielitaitotasoDto;
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.vst.KotoLaajaAlainenOsaaminenDto;
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.vst.KotoOpintoDto;
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.vst.OpintokokonaisuusDto;
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.vst.TavoitesisaltoalueDto;
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.yl.TaiteenalaDto;
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.yl.lukio.osaviitteet.AihekokonaisuudetLaajaDto;
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.yl.lukio.osaviitteet.LukioOpetussuunnitelmaRakenneLaajaDto;
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.yl.lukio.osaviitteet.OpetuksenYleisetTavoitteetLaajaDto;
