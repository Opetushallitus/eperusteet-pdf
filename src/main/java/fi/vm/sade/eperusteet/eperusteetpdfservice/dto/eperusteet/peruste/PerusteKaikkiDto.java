...
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.eperusteet.opas.lops2019.Lops2019SisaltoDto;
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.eperusteet.tutkinnonosa.TutkinnonOsaKaikkiDto;
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.eperusteet.tuva.KoulutuksenOsaDto;
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.eperusteet.tuva.TutkintoonvalmentavaSisaltoDto;
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.eperusteet.vst.VapaasivistystyoSisaltoDto;
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.eperusteet.yl.AIPEOpetuksenSisaltoDto;
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.eperusteet.yl.EsiopetuksenPerusteenSisaltoDto;
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.eperusteet.yl.PerusopetuksenPerusteenSisaltoDto;
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.eperusteet.yl.TPOOpetuksenSisaltoDto;
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.eperusteet.yl.lukio.julkinen.LukiokoulutuksenPerusteenSisaltoDto;
