...
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.opas.lops2019.Lops2019SisaltoDto;
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.tutkinnonosa.TutkinnonOsaKaikkiDto;
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.tuva.KoulutuksenOsaDto;
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.tuva.TutkintoonvalmentavaSisaltoDto;
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.vst.VapaasivistystyoSisaltoDto;
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.yl.AIPEOpetuksenSisaltoDto;
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.yl.EsiopetuksenPerusteenSisaltoDto;
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.yl.PerusopetuksenPerusteenSisaltoDto;
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.yl.TPOOpetuksenSisaltoDto;
import fi.vm.sade.eperusteet.eperusteetpdfservice.dto.yl.lukio.julkinen.LukiokoulutuksenPerusteenSisaltoDto;
